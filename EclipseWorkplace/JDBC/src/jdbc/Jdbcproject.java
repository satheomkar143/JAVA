...
public class Jdbcproject extends JFrame implements ActionListener
{
	 ...
	 JFrame jm=new JFrame();
		...
		JLabel l5=new JLabel("Student contact:");
...
else if(e.getSource()==btn3)
{
	...
	String contact=text5.getText();
	   ...
	   PreparedStatement ps=con.prepareStatement("update studentinfo set name='"+name+"', age='"+age+"',city='"+city+"',contact='"+contact+"' where rollno='"+rollno+"'");
   ps.execute();
